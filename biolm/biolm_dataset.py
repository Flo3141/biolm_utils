...
Backwards-compatibility:
    - `biolm.rna_datasets.RNABaseDataset` remains available as a deprecated import
      path and re-exports this implementation.
"""
...
class BioLMDataset(RNABaseDataset):
    """Canonical dataset base class for plugins."""
